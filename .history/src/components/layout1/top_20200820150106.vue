...
<div class="header-bar">
        ...
        <div class="header-bar-position">
            <span class="position-name">
                <img class="location" src="location_map_navigation1.png"></img>
                成都
                ...
                <li class="has-child"><a>网站导航</a>
                    <div class="header-nav-site_header-nav-second">
                        ...
                        <dl class="header-nav-mobile_app-nav-third">
                            <dt >手机应用</dt>
                            <dd><a href="https://i.meituan.com/mobile/down/meituan" target="_blank"><img class="app-icon" src="mtAPP.png"></img></a></dd>
                            <dd><a href="https://waimai.meituan.com/mobile/download/default" target="_blank"><img class="app-icon" src="mtwmAPP.png"></img></a></dd>
                            <dd><a href="https://phoenix.meituan.com/app/" target="_blank"><img class="app-icon" src="zgAPP.png"></img></a></dd>
                            <dd><a href="https://www.dianping.com/app/download" target="_blank"><img class="app-icon" src="dzdpAPP.png"></img></a></dd>
                            <dd><a href="https://maoyan.com/app" target="_blank"><img class="app-icon" src="myAPP.png"></img></a></dd>
                        </dl>
                    </div>
                </li>
            </ul>
