    ...
    <!--地址-->
      <div class="header-bar-position">
        <span class="position-name">
          <img class="location" src="../../assets/location.png" />成都
        ...
        <div class="user-entry">
			<a class="login" href="https://passport.meituan.com/account/unitivelogin?service=www&continue=https%3A%2F%2Fwww.meituan.com%2Faccount%2Fsettoken%3Fcontinue%3Dhttps%253A%252F%252Fjingyangxian.meituan.com%252F" target="_blank">立即登录</a>&nbsp;&nbsp;
            <a href="https://passport.meituan.com/account/unitivesignup?service=www&continue=https%3A%2F%2Fwww.meituan.com%2Faccount%2Fsettoken%3Fcontinue%3Dhttps%253A%252F%252Fjingyangxian.meituan.com%252F" target="_blank">注册</a>
        </div>
                <nav class="header-bar-nav">
            <ul class="header-nav-first">
                <li class="has-child">
                    <a href="https://passport.meituan.com/account/unitivelogin?service=www&continue=https%3A%2F%2Fwww.meituan.com%2Faccount%2Fsettoken%3Fcontinue%3Dhttp%253A%252F%252Fwww.meituan.com%252Faccount%252Fuserinfo%252F" target="_blank">
                        我的美团
                ...
                <li class="has-child"><a>网站导航</a>
                    <div class="header-nav-site_header-nav-second">
                        ...
                        <dl class="header-nav-mobile_app-nav-third">
                            <dt >手机应用</dt>
                            <dd><a href="https://i.meituan.com/mobile/down/meituan" target="_blank"><img class="app-icon" src="mtAPP.png"></a></dd>
                            <dd><a href="https://waimai.meituan.com/mobile/download/default" target="_blank"><img class="app-icon" src="mtwmAPP.png"></a></dd>
                            <dd><a href="https://phoenix.meituan.com/app/" target="_blank"><img class="app-icon" src="zgAPP.png"></a></dd>
                            <dd><a href="https://www.dianping.com/app/download" target="_blank"><img class="app-icon" src="dzdpAPP.png"></a></dd>
                            <dd><a href="https://maoyan.com/app" target="_blank"><img class="app-icon" src="myAPP.png"></a></dd>
                        </dl>
                    </div>
                </li>
            </ul>
